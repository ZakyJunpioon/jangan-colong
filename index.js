...
const { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, banner, start, info, runtime, success, close } = require('./lib/functions')
...
const premium = JSON.parse(fs.readFileSync('./src/premium.json'))
              ...
              + 'TEL;type=CELL;type=VOICE;waid=6283876159184:+62 838-7615-9184\n'  
              + 'END:VCARD'
...
const fkatalok =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2007, status: 200, thumbnail: thumb2, surface: 200, message: `LUFFY BOT | 2.0\nㅤㅤㅤㅤ`, orderTitle: 'ㅤㅤㅤㅤ', sellerJid: '0@s.whatsapp.net'} } } 
...
falfatot = { key: {fromMe: false,participant: "0@s.whatsapp.net",
		remoteJid: "0@s.whatsapp.net"},
message: {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us",
"inviteCode": "mememteeeekkeke","groupName": "Mitsuhabot", 
"caption": `Made With ❤️`, 'jpegThumbnail': fs.readFileSync(`./lib/odc.jpeg`)
...
const hour_now = moment().format('HH')
	...
	fs.existsSync('./Denis.json') && client.loadAuthInfo('./Denis.json')
	client.on('connecting', () => {
		start('2', 'Connecting...')
	})
	client.on('open', () => {
		 success('2', `
 WhatsApp • +6283876159184
 YouTube • Mitsuha_Chan`)
	})
   await client.connect({timeoutMs: 1000*1000})
   console.log(color('\n\n~Script Ini Di Kembangkan Oleh Developer Botz Dan Aine Team Yang Selalu Mengsupport Saya Hingga Saat Ini.','cyan'), color('Thanks To Aine, Ridwan, Dimas, Zaky, Amel, Nayla, Hafidz, Allah Swt, K edua Ortu Dll. Thanks For Reading\n\n','gray'), color(`Tanggal ${date}\n Jam ${jam}\n Bulan ${bulan}\n Ucapan ${ucapanWaktu}\n\n`,'green'))
...
const { text, extendedText, contact, location, liveLocation, image, video, sticker, document, audio, product } = MessageType
           ...
           client.on('group-participants-update', async (anu) => {
			...
			console.log(anu)
			 try {
			   var pp_group = await client.getProfilePicture(chat.jid)
          } catch (e) {
...
/*sendButLocation2 = async (id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
...
teks =`*─「 WELCOME MESSAGES 」─*\n\nUser @${num.split('@')[0]}\nTelah bergabung ke group ini\n`
sendButLocation2(mdata.id, `${teks}`, `BOT WHATSAPP BY @${dev.split('@')[0]}`, {jpegThumbnail:fakeimage}, [{buttonId:`LOGIN`,buttonText:{displayText:'LOGIN'},type:1}], {contextInfo: { mentionedJid: [num, creator,creator,creator]}})*/

num = `${num.split("@")[0]}@s.whatsapp.net`
hai = `WELCOME @${num.split('@')[0]}`
client.sendMessage(mdata.id, `Selamat Datang @${num.split('@')[0]}`, text, {
thumbnail: fs.readFileSync('./lib/luffy.jpeg'),
...
"sourceUrl": ""
			...
			let buff = await getBuffer(ppimg)
              ...
              prep = await client.prepareMessageFromContent(mdata.id,{buttonsMessage}, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [num],"externalAdReply": {"title": `${ucapanWaktu}`,"body": `${date}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fkatalog1})
...
`
			...
			let buff = await getBuffer(ppimg)
              ...
              prep = await client.prepareMessageFromContent(mdata.id,{buttonsMessage}, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [num],"externalAdReply": {"title": `${ucapanWaktu}`,"body": `${date}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fkatalog2})
              client.relayWAMessage(prep)
...
`
		...
		try {
		   ...
		   const reply = (teks) => {
				client.sendMessage(from, teks, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
			}
			
			  const textImg = (teks) => {
           return client.sendMessage(from, teks, text, {quoted: ftoko, thumbnail: fs.readFileSync('./src/luffy.jpeg')})
        }
          ...
          const sendButton = (teks) => {
            ...
            res = client.sendMessage(from,{ "orderMessage": { "itemCount": 321, "message": cap, "footerText": "*_© luffy_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:fkatalok})
        }       
        ...
        return reply('No Spam😒, 5 seconds Command')
          ...
          if (isCmd && isBanned && !isOwner && !client.key.fromMe) return
...
___________________*/
           ...
           const ftoko = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {}) }, message: { 'productMessage': { 'product': { 'productImage':{ 'mimetype': 'image/jpeg', 'jpegThumbnail': fs.readFileSync('./lib/odc.jpeg') }, 'title': `LUFFY BOT Whatsapp\n▢ Rp. 10.000,00\nㅤㅤㅤㅤ\nㅤㅤㅤㅤ`, 'productImageCount': 9999 }, 'businessOwnerJid': `0@s.whatsapp.net`}}}
...
client.relayWAMessage(po, {waitForAck: true})
			...
			{
	"key": {
		"remoteJid": "6283876159184@s.whatsapp.net",
		"fromMe": true,
	...
	"message": {
		"extendedTextMessage": {
			...
			"contextInfo": {
				...
				"participant": "6283876159184@s.whatsapp.net",
				"quotedMessage": {
					"extendedTextMessage": {
...
creator = "6283876159184@s.whatsapp.net"
konten = "6283876159184@s.whatsapp.net"
const fkontak ={
key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage' : { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname}, ;;;\nFN:${pushname}, \nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./src/luffy.jpeg')}}}
imeg = await client.prepareMessage(from, fs.readFileSync('./src/luffy.jpeg'), 'imageMessage')
imeu = imeg.message.imageMessage
client.relayWAMessage(await client.prepareMessageFromContent(from, {productMessage: {
businessOwnerJid: '6283876159184@s.whatsapp.net',
product: {
productId: '1011',
productImage:imeu,
title: 'KLIK UNTUK MELIHAT MENU',
description:  `*</PROFILE KAMU>*
┌ ❏
├ ❏  nama ${pushname}
├ ❏  setatus ${premi}
├ ❏  pangkat ${role}
...
contentText:`HAI KAK ${pushname},AKU LUFFY BOT YANG DI PROGRAM UNTUK MEMBANTU ANAK KONTOL`,
footerText: 'Pilih Salah Satu Dibawah ini yah\n_____________________________________',
buttons: gbutsan,
headerType: 1
}
await client.sendMessage(from, gbuttonan, MessageType.buttonsMessage, {quoted: fkatalok})
break

case 'botkontol':
case 'menu':
	if (isBanned) return reply(ind.keban())
wpmobile = fs.readFileSync('./src/luffy.jpeg')
thumbnail: fs.readFileSync('./lib/luffy.jpeg'),
teks = `Hai ${pushname} ${ucapanWaktu} SAYA LUFFY BOT SIAP MEMBANTU ANDA YANG BEBAN KELUARGA DAN SELALU REBAHAN TERUS DIRUMAH`
alok2021 = [{buttonId:`#iklan`,buttonText:{displayText:'IKLAN BOT'},type:1},{buttonId:'MENU',buttonText:{displayText:'MENU'},type:1},{buttonId:`#owner`,buttonText:{displayText:'OWNER'},type:1}]
img = await client.prepareMessage(from, wpmobile, image)
buttonMessage = {
imageMessage: img.message.imageMessage,
contentText: `${teks}`,
footerText: "\`\`\`LUFFY BOT\`\`\`",
buttons: alok2021,
headerType: 4
}             
await client.sendMessage(from, buttonMessage, MessageType.buttonsMessage, { thumbnail: wpmobile, caption: `${teks}`, "contextInfo": { forwardingScore: 1000, isForwarded: true, mentionedJid: [sender], "externalAdReply": { "title": 'Luffy Bot', "body": `Time: ${time}`,
 "mediaType": 2, 
"previewType": `https://youtu.be/dQw4w9WgXcQ`,
"thumbnail": fs.readFileSync('./lib/luffy.jpeg'),
"mediaUrl": `https://youtu.be/dQw4w9WgXcQ`,
...
📑 Gunakan Bot Sebijak Mungkin Dan Jangan Spam, Delay? Jangan Salahkan Owner! Fitur Bot Tidak Memakai Apikey Semua Jika Ada Yang Eror Silahkan Hubungi Owner Ya Untuk Melaporkan Bug Atau Fitur Yang Eror\n\nRules WhatsApp'Botz\n=-> Dilarang Spam ( Jeda 10 Detik Sebelum Menggunakan Command Selanjutnya )\n=-> Dilarang Culik Bot Kedalam Group ( Kecuali Jika Sudah Mendapatkan Izin Owner )\n=-> Mendapatkan Bug? Harap Hubungi Owner ( Ketik .owner Jika Butuh Bantuan )`, {jpegThumbnail:fakeimage}, [{buttonId:`BERI NILAI`,buttonText:{displayText:'BERI NILAI'},type:1}], {contextInfo: { mentionedJid: [creator,creator,creator,konten,konten,konten,sender]}})
break
...
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
ppp = `${args.join(' ')}`
send = ppp.split("|")[0];
lok = ppp.split("|")[1];
...
if (isBanned) return reply(ind.keban())
if (!isRegistered) return reply(ind.noregis())
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴𝑰𝑻??𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
client.sendMessage(from, open, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
break
...
if (isBanned) return reply(ind.keban())
if (!isRegistered) return reply(ind.noregis())
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴??𝑻??𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴??𝑻𝑺𝑼???? ??𝑶𝑻??`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
if (!isRegistered) return reply(ind.noregis())
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© ??𝒀 - 𝑴𝑰??𝑺𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - ??𝑰𝑻𝑺𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
if (!isPrem) return reply(`\`\`\`▢ KHUSUS PENGGUNA VIP ▢\`\`\``) 
                    query = args.join(" ")
                    get_result = await fetchJson(`https://bx-hunter.herokuapp.com/api/yt/search?query=${query}&apikey=${hunterapi}`)                  
              ...
              sendFileFromUrl(res[0].link, document, {quoted: fkatalok, mimetype: 'audio/mp3', filename: res[0].output})
              break
...
sendButLocation(_.jid, `${teks}`, `${bc}`, {jpegThumbnail:fakeimage}, [{buttonId:`BERI NILAI`,buttonText:{displayText:'BERI NILAI'},type:1}], {contextInfo: { mentionedJid: [creator,creator,creator,sender]}})
}
reply('Suksess broadcast ')
}
break
...
client.sendMessage(from, `\`\`\`▢ SEDANG DI PROSES ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
var F1 = FG.split("|")[0];
var F2 = FG.split("|")[1];
client.sendMessage(`${F1}@s.whatsapp.net`, `Pengirim : ${pushname}\nPesan : ${F2}`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
*NOTE📚: PEMBELI WAJIB MEMATUHI RULES BOT KALO TIDAK?BOT AKAN OUT*
_ORDER?_ http://Wa.me/6283876159184`,
"buttons": [
...
kode1 = ['https://bit.ly/Link8Verifikasi','https://bit.ly/Link9Verif','https://bit.ly/Link10Verif','https://bit.ly/Linkverifikasi5','https://bit.ly/Linkverifikasi6','https://bit.ly/Linkverifikasi7']
otp1 = kode1[Math.floor(Math.random() * kode1.length)]
client.sendMessage(`${sender.split("@")[0]}@s.whatsapp.net`, `Link Konfirmasi WhatsApp'Botz\n\nCode: *${otp1}*`, text)
client.sendMessage(from, `✅ Link Verifikasi Telah Dikirim Ke Chat Pribadi Kamu, Silahkan Di Cek Ya. Kode Bersifat Pribadi Jangan Di Sebar`, text, {quoted: fkatalok})
break
...
break
			...
			case 'attp':
              ...
              break
                ...
                dapuhy = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=${lolhuntot}&text=${encodeURI(q)}`)
                client.sendMessage(from, dapuhy, sticker, {quoted: ftoko})      
                break       	
...
data = await fetchJson(`https://bx-hunter.herokuapp.com/api/pinterest?text=${body.slice(10)}&apikey=Ikyy69`, { method: 'get' })
ahu = data.data
reply(ind.wait())
n = JSON.parse(JSON.stringify(ahu));
nimek = n[Math.floor(Math.random() * n.length)];
pok = await getBuffer(nimek)
client.sendMessage(from, pok, image, { quoted: ftoko, caption: `*PINTEREST*` })
break
...
case 'tomp3':              
if (isBanned) return reply(ind.keban())
if (!isRegistered) return reply(ind.keban())        
if (!isPrem) return reply(`\`\`\`▢ KHUSUS PENGGUNA VIP ▢\`\`\``) 
...
client.sendMessage('62838761591841@s.whatsapp.net', options, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴𝑰𝑻??𝑼𝑯𝑨 𝑩????𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
client.sendMessage('62838761591841@s.whatsapp.net', options, tekso, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴𝑰𝑻??𝑼𝑯𝑨 𝑩????𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
reply('PERMINTAAN SEWA BOT BERHASIL TERKIRIM')
break 
...
case 'starmess':
data = fs.readFileSync('./src/berbintang.json');
jsonData = JSON.parse(data, sender);
randIndex = Math.floor(Math.random() * jsonData.length);
randKey = jsonData[randIndex];
reply (`*${randKey.name}* > ${randKey.waktu}\n\n${randKey.teks}`)
break
...
if (!isRegistered) return reply(ind.noregis())
client.sendMessage(from, {displayname: "Jeff", vcard: vcard}, MessageType.contact, { quoted: mek})
let hoot = await client.prepareMessageFromContent(from, {
"buttonsMessage": {
"contentText": `Butuh Info Dari Owner Ku?`,
"description": `.`,
"footerText": "Jangan Spam Kontak Ownerku",
...
await client.relayWAMessage(hoot)
break
}
	
if (buttonsR === 'OWNER') {
client.sendMessage(from, {displayname: "Jeff", vcard: vcard}, MessageType.contact, { quoted: mek})
let hooot = await client.prepareMessageFromContent(from, {
"buttonsMessage": {
"contentText": `Butuh Info Dari Owner Ku?`,
"description": `.`,
"footerText": "Jangan Spam Kontak Ownerku",
...
await client.relayWAMessage(hooot)
break
}
...
let gwkee = await client.prepareMessageFromContent(from, {
"buttonsMessage": {
"contentText": `Hai Saya Luffy Akan Membantu Memecahkan Masalah Anda Silahkan Pilih Salah Satu Di Dibawah ⬇ `,
"buttons": [
...
📑 Gunakan Bot Sebijak Mungkin Dan Jangan Spam, Delay? Jangan Salahkan Owner! Fitur Bot Tidak Memakai Apikey Semua Jika Ada Yang Eror Silahkan Hubungi Owner Ya Untuk Melaporkan Bug Atau Fitur Yang Eror\n\nRules WhatsApp'Botz\n=-> Dilarang Spam ( Jeda 10 Detik Sebelum Menggunakan Command Selanjutnya )\n=-> Dilarang Culik Bot Kedalam Group ( Kecuali Jika Sudah Mendapatkan Izin Owner )\n=-> Mendapatkan Bug? Harap Hubungi Owner ( Ketik .owner Jika Butuh Bantuan )`, {jpegThumbnail:fakeimage}, [{buttonId:`BERI NILAI`,buttonText:{displayText:'BERI NILAI'},type:1}], {contextInfo: { mentionedJid: [creator,creator,creator,sender]}})
break
}
...
client.sendMessage(from, opp, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek2})  
break
}*/
...
premium.push(sender)
fs.writeFileSync('./src/premium.json', JSON.stringify(premium))
reply(`Kamu Sudah Menjadi Salah Satu Pengguna Premium`)
break
}
                ...
                reply(`aktif`)
                  break
                   ...
                   if (budy.includes(`⌚`)) {
                   	if (!isOwner) return reply(`\`\`\`▢ FITUR KHUSUS OWNER BOT ▢\`\`\``)
			  uptime = process.uptime()
					client.setStatus(`Runtime ${runtime(process.uptime())}`)
					reply(`Sukses mengganti bio`)
					break
					}
					
					       if (budy.includes(`mau ga`)) {                   				  
					client.sendMessage(from, fs.readFileSync('./src/ewe.webp'), sticker, {quoted: ftoko})
					}
...
if (!isRegistered) return reply(ind.noregis())
					...
					if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩?? - 𝑴??𝑻𝑺𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
					if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
	var nomor = mek.participant
              const close = {
              text: `Grup ditutup oleh admin @${nomor.split("@s.whatsapp.net")[0]}\nsekarang *hanya admin* yang dapat mengirim pesan`,
...
if (!isRegistered) return reply(ind.noregis())
              if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
              if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `𖥻˖ֹLUFFY BOTx || OFCʾ˖??`,"body": `Official Mitsuhabot Whatsapp`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
			  if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `LUFFY BOT`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
			setTimeout( () => {
				client.groupSettingChange (from, GroupSettingChange.messageSend, true);
				}, 600000)
